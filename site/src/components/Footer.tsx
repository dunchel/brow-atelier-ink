  ...
  return (
    <footer className="bg-brand-dark text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          <h3 className="font-heading text-xl mb-4">Brow Atelier & Ink</h3>
          <p className="text-sm text-gray-300 leading-relaxed">
            Het gezelligste brow &amp; lash atelier van Helmond. Stap binnen,
            geniet van een cappuccino of bubbels en laat je in de watten leggen.
          </p>
        </div>
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2">
            <Link href="/" className="text-sm text-gray-300 hover:text-brand-gold transition-colors">Home</Link>
            <Link href="/diensten" className="text-sm text-gray-300 hover:text-brand-gold transition-colors">Diensten</Link>
            <Link href="/wenkbrauwen" className="text-sm text-gray-300 hover:text-brand-gold transition-colors">Brows</Link>
        ...
        <div>
          ...
          <address className="not-italic text-sm text-gray-300 space-y-2">
            ...
            <p>5707 AM, Helmond</p>
            <p>
              <a href="tel:+31623747712" className="hover:text-brand-gold transition-colors">
                06-23747712
              </a>
            </p>
            <p>
              <a href="mailto:BrowAtelier.Ink@gmail.com" className="hover:text-brand-gold transition-colors">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-primary text-xs mt-6 inline-block"
          >
            Plan je Brow Date
          </a>
        </div>
      ...
      <div className="border-t border-gray-700 text-center py-6">
        <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Brow Atelier &amp; Ink &bull; All Rights Reserved
        </p>
      </div>
    </footer>
  );
